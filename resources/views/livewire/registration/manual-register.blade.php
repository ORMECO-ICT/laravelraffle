<div>
    @if($consumer->manual_registration == null)
        <button wire:click="$toggle('showModal')" class="btn btn-success btn-sm mx-1">Register</button>
        ...
        <x-dialog-modal wire:model="showModal">
            ...
            <x-slot name="footer">
                ...
                <x-success-button class="ml-2" wire:click="register('{{$consumer->account_no}}')" wire:loading.attr="disabled">
                    Register
                </x-success-button>
            </x-slot>
        </x-dialog-modal>
