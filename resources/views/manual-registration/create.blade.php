            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <p class="mt-6 text-gray-500 leading-relaxed">
                        ...
                        <form method="POST" action="{{ route('manual-registration.store') }}">
                            @csrf
                            ...
                            <div class="mt-4">
                                <x-label for="account_no" value="{{ __('ID') }}" />
                                <x-input id="account_no" class="block mt-1 w-full" type="text" name="account_no"
                                    :value="old('account_no')" required autofocus autocomplete="account_no" readonly />
                            </div>
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                    href="{{ route('manual-registration.') }}">
                                    {{ __('Back to list') }}
                                </a>
